...
// These are the status codes used by the DeviceDrivers.  The list is
// copied from C/Linux errno.h, except that we are limited to 127 codes, so
// the last few in the list are not available for our use.
...
#define ENOSYS      38  /* Function not implemented at all */
