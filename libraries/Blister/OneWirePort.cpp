/*
  OneWirePort.cpp - Firmata library
...
boolean OneWirePort::handleSetPinMode(byte pin, int mode)
{
...
void OneWirePort::handleGetCapability(byte pin)
{
...
void OneWirePort::oneWireConfig(byte pin, boolean power)
{
...
boolean OneWirePort::handleFeatureSysex(byte command, byte argc, byte* argv)
{
